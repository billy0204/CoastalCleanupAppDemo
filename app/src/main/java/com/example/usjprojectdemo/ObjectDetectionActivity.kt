...
class ObjectDetectionActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.imgSampleTwo -> {
                setViewAndDetect(getSampleImage(R.drawable.demo_2))
            }
            R.id.imgSampleThree -> {
                setViewAndDetect(getSampleImage(R.drawable.demo_2))
            }
...
//            .setAssetFilePath("lite-model_yolo-v5-tflite_tflite_model_1.tflite")
            ...
            takePictureIntent.resolveActivity(packageManager)?.also {
                ...
                photoFile?.also {
                    val photoURI: Uri = FileProvider.getUriForFile(
                        this,
                        "com.example.usjprojectdemo.fileprovider",
                        it
                    )
